...
struct matrix * make_rotX(double theta) {
  ...
  rotateX = new_matrix(4,4);
  ident(rotateX);
  theta = (theta * M_PI)/180;
  rotateX->m[1][1] = cos(theta);
  rotateX->m[1][2] = -sin(theta);
  rotateX->m[2][1] = sin(theta);
  rotateX->m[2][2] = cos(theta);
  return rotateX;
}
...
struct matrix * make_rotY(double theta) {
  ...
  rotateY = new_matrix(4,4);
  ident(rotateY);
  theta = (theta * M_PI)/180;
  rotateY->m[0][0] = cos(theta);
  rotateY->m[0][2] = sin(theta);
  rotateY->m[2][0] = -sin(theta);
  rotateY->m[2][2] = cos(theta);
  return rotateY;
}
...
struct matrix * make_rotZ(double theta) {
  ...
  rotateZ = new_matrix(4,4);
  ident(rotateZ);
  theta = (theta * M_PI)/180;
  rotateZ->m[0][0] = cos(theta);
  rotateZ->m[0][1] = -sin(theta);
  rotateZ->m[1][0] = sin(theta);
  rotateZ->m[1][1] = cos(theta);
  return rotateZ;
}
